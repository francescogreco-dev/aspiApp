...
export class IncidentData {
  ...
  constructor(dati?: any) {
    if (dati != null) {
      this.id_incident = dati.id_incident;
      this.id_technical = dati.id_technical
      this.incident_notes = dati.incident_notes;
      this.incident_number = dati.incident_number;
      this.incident_number_internal = dati.incident_number_internal;
      this.is_close = dati.is_close;
      this.is_planned = dati.is_planned;
      this.note = dati.note;
      this.phone_1 = dati.phone_1;
      this.phone_2 = dati.phone_2;
      this.planned_date = dati.planned_date;
      this.province = dati.province;
      this.request_date = dati.request_date;
      this.requested_time = dati.requested_time;
      this.status = dati.status;
      this.symptom = dati.symptom;
      this.address = dati.address;
      this.appointment = dati.appointment;
      this.client = dati.client;
      this.common = dati.common;
      this.contact_name = dati.contact_name;
      this.destination = dati.destination;
      this.device = dati.device;
      this.event_type = dati.event_type;
    }
  }
